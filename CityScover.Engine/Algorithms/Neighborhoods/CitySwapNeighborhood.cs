...
{
   internal class CitySwapNeighborhood : Neighborhood<InterestPointWorker, IEnumerable<RouteWorker>>
   {
      ...
      internal override ICollection<TOSolution> BuildNeighborhood(InterestPointWorker currentEdge, IEnumerable<RouteWorker> candidateEdges)
      {
         throw new NotImplementedException();
      }

      internal override IDictionary<InterestPointWorker, IEnumerable<RouteWorker>> GetCandidates(in TOSolution solution)
      {
         throw new NotImplementedException();
      }

      internal override TOSolution ProcessCandidate(InterestPointWorker currentEdge, InterestPointWorker candidateEdge)
      {
         throw new NotImplementedException();
      }
      #endregion
